...
INSERT INTO [NAMES] ([ID], [CURIE], [CATEGORY], [NAME], [TAXON])
SELECT [ID], [CURIE], [CATEGORY], [NAME], [TAXON] FROM [NAMES_OLD];
...
INSERT INTO [SYNONYMS] ([ID], [L1], [L3])
SELECT [ID], [L1], [L3] FROM [SYNONYMS_OLD];
CREATE TABLE [MESHTERMS] (
    [PMID] INTEGER PRIMARY KEY,
    [MESH] TEXT,
    [MESH_MAJOR] TEXT
);
INSERT INTO [MESHTERMS] ([PMID], [MESH], [MESH_MAJOR])
SELECT [PMID], [MESH], [MESH_MAJOR] FROM [MESHTERMS_OLD];
CREATE TABLE [INFORMATION] (
    [PMID] INTEGER PRIMARY KEY REFERENCES [MESHTERMS]([PMID]),
    [FIRST_AUTHOR] TEXT,
    [YEAR] INTEGER,
    [JOURNAL] TEXT,
    [TITLE] TEXT
);
INSERT INTO [INFORMATION] ([PMID], [FIRST_AUTHOR], [YEAR], [JOURNAL], [TITLE])
SELECT [PMID], [FIRST_AUTHOR], [YEAR], [JOURNAL], [TITLE] FROM [INFORMATION_OLD];
CREATE TABLE [IDENTIFIERS] (
    [PMID] INTEGER REFERENCES [MESHTERMS]([PMID]),
    [ALT] TEXT
);
INSERT INTO [IDENTIFIERS] ([PMID], [ALT])
SELECT [PMID], [ALT] FROM [IDENTIFIERS_OLD];
CREATE TABLE [PMCCAPTIONS] (
    [PMC] INTEGER PRIMARY KEY,
    [FILE] TEXT,
    [CAPTION] TEXT
);
INSERT INTO [PMCCAPTIONS] ([PMC], [FILE], [CAPTION])
SELECT [PMC], [FILE], [CAPTION] FROM [PMCCAPTIONS_OLD];
-- BUILD NEW INDEXES FOR TBDB
...
CREATE INDEX [IDX_PMCCAPTIONS_FILE] ON [PMCCAPTIONS]([FILE]);
-- COMMIT CHANGES
COMMIT;
